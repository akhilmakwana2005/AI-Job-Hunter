    ...
    const mockMatches = [
      {
        ...
        salary: '₹35L - ₹45L',
        matchScore: 96,
        matchReasons: ['Matches your 5+ years experience', `Requires ${skills[0] || 'Frontend'} which is your top skill`, 'Remote preference matches'],
      ...
      },
      {
        ...
        salary: '₹28L - ₹40L',
        matchScore: 92,
        matchReasons: [`Strong overlap with your ${skills[1] || 'Backend'} skills`, 'Fintech domain matches your previous role'],
      ...
      },
      {
        ...
        salary: '₹30L - ₹50L',
        matchScore: 89,
        matchReasons: ['Leadership experience required', 'Tech stack aligns perfectly with your resume'],
      ...
      },
      {
        ...
        salary: '₹25L - ₹35L',
        matchScore: 85,
        matchReasons: ['Remote work available', `Requires knowledge of ${skills[2] || 'Databases'} which you possess`],
